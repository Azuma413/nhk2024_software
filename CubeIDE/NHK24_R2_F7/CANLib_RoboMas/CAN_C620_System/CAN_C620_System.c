...
void _change_internal_offset_for_calib(C620_DeviceInfo *device_info){
    _c620_feedback_data_raw_global[device_info->device_id]._internal_offset_pos = _c620_feedback_data_raw_global[device_info->device_id].pos;
    _c620_feedback_data_raw_global[device_info->device_id]._rot_num = 0;
}
